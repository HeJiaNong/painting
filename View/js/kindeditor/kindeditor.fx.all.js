...
(function (window, undefined) {
    ...
    _extend(KUploadButton, {
        init: function (options) {
            ...
            var html = ['<div class="ke-inline-block ' + cls + '">', (options.target ? "" : '<iframe name="' + target + '" style="display:none;"></iframe>'), (options.form ? '<div class="ke-uploads-area">' : '<form class="ke-uploads-area ke-form" method="post" enctype="multipart/form-data" target="' + target + '" action="' + url + '">'), '<span class="ke-button-common">', hiddenElements.join(""), '<input type="button" class="ke-button-common ke-button" value="' + title + '" />', "</span>", '<input type="file" class="ke-uploads-file" name="' + fieldName + '" tabindex="-1" />', (options.form ? "</div>" : "</form>"), "</div>"].join("");
